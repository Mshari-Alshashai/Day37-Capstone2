...
public class NotificationController {
    ...
    @PostMapping("/add")
    public ResponseEntity addNotification(@RequestBody @Valid Notification notification, Errors errors) {
        if (errors.hasErrors()) {
    ...
    public ResponseEntity updateNotification(@PathVariable Integer id,@RequestBody @Valid Notification notification, Errors errors) {
        if (errors.hasErrors()) {
            return ResponseEntity.badRequest().body(errors.getFieldError().getDefaultMessage());
        }
